...
from ..theme import (
    ...
    F_CARD_TITLE, F_H3, F_ITEM_TITLE, F_SECTION, F_SMALL, F_SMALL_B, SUCCESS, TEXT, TEXT_MUTED,
    WARNING, qfont,
)
from ..widgets import (
...
def _rating_widget(parent, quality: int, speed: int) -> QWidget:
    ...
    shared gui_qt widget library (per gui_qt/README.md, it wasn't in scope
...
class _StringVar:
    ...
    tk.StringVars. Not part of gui_qt/widgets.py (widgets.py only has
    ...
    def _wizard_toggle_card(self, parent, *, key: str, title: str, icon_kind: str, installed: bool,
        ...
        if installed:
            if queued:
                ...
                status_text, status_color, right_icon_kind, right_icon_color = (
                    "installed", SUCCESS, "check", SUCCESS)
        else:
            if queued:
                status_text, status_color, right_icon_kind, right_icon_color = (
        ...
        def update_card_ui():
            ...
            if q:
                ...
                if installed:
                    ds, sc, rik, ric = "installed", SUCCESS, "check", SUCCESS
                else:
        ...
        if is_card_enabled:
            card = RoundedCard(parent, bg=card_bg, border=CARD_BORDER, command=on_card_click,
                                ...
                                active_width=active_width, hover_border=ACCENT)
        else:
