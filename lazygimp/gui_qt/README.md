# lazygimp/gui_qt — PySide6 engine (Phase 1: theme + widget library)
...
| Old (`gui/theme.py`) | New (`gui_qt/theme.py`) | Notes |
|---|---|---|
...
| Old (`gui/widgets.py`) | New (`gui_qt/widgets.py`) | Behavior differences |
|---|---|---|
...
| Old (`gui/icons.py`) | New (`gui_qt/icons.py`) | Notes |
|---|---|---|
...
| Old (`gui/dialogs.py`) | New (`gui_qt/dialogs.py`) | Notes |
|---|---|---|
...
python3 -m lazygimp.gui_qt._smoke_test
```
...
- Wiring `gui_qt` into `lazygimp/cli.py` / `launch_gui()` — the Tk GUI
